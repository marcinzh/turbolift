...
private[turbolift] object ComputationCases:
  ...
  final class Resume[A, U](val ctrl: Control.Untyped, val value: Any, val stan: Any) extends Unsealed[A, U](Tags.Resume)
  final class Local[A, U](val ctrl: Control.Untyped, val body: Untyped, val stan: Any) extends Unsealed[A, U](Tags.Local)
